 ...
 * <p>
 * Adapted from <a href="https://github.com/aclarkxyz/web_molkit">WebMolKit</a>
 */
public class MdlMolParser {

    private MdlMolParser() {
    ...
    /**
     * Parse am MDL MOL file and return a Molecule object.
     *
     * @param str The MDL MOL file as a string.
     * @return A Molecule object.
     * @throws BadMolFormatException If the MDL MOL file is not well-formed.
     */
